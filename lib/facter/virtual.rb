    ...
    setcode do
        ...
        if $?.exitstatus == 0
            ...
            output.each {|p|
                        ...
                        result = "vmware" if p =~ /VMware/i
            }
        
        elsif FileTest.exists?("/usr/lib/vmware/bin/vmware-vmx")
            result = "vmware_server"
        elsif FileTest.exists?("/proc/xen/capabilities") and File.read("/proc/xen/capabilities") =~ /control_d/i
            result = "xen0"
